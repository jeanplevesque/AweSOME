...
namespace Krypton
{
    ...
    public class KryptonEngine : DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            RenderHelper = new KryptonRenderHelper(this.GraphicsDevice, this.mEffect);
        ...
        private void CreateRenderTargets()
        {
            ...
            this.mMapTemp = new RenderTarget2D(GraphicsDevice, targetWidth, targetHeight, false, SurfaceFormat.Color, DepthFormat.Depth24Stencil8, 0, RenderTargetUsage.PlatformContents);
            ...
            this.mMapFinal = new RenderTarget2D(GraphicsDevice, targetWidth, targetHeight, false, SurfaceFormat.Color, DepthFormat.Depth24Stencil8, 0, RenderTargetUsage.PreserveContents);
        }
        ...
        public void LightMapPrepare()
        {
            ...
            this.GraphicsDevice.SetRenderTarget(this.mMapFinal);
            this.GraphicsDevice.Clear(this.mAmbientColor);
            ...
            foreach (var light in this.mLights)
            {
                if (light.IsOn)
                {
                    ...
                    this.GraphicsDevice.SetRenderTarget(this.mMapTemp);
                    this.GraphicsDevice.Clear(ClearOptions.Target | ClearOptions.Stencil, Color.Black, 0, 0);
